              ...
              {purgeDate && (
                <div className="p-3.5 bg-rose-50 border border-rose-100 rounded-2xl flex items-start gap-2.5 text-rose-800 text-[11px] leading-relaxed animate-in fade-in duration-300">
                  ...
                  <div>
                    ...
                    Toutes les transactions correspondantes datées d'avant le <span className="font-bold underline">{new Date(purgeDate).toLocaleDateString('fr-FR')}</span> incluse seront définitivement supprimées afin d'alléger la base de données.
                  </div>
                </div>
              )}
