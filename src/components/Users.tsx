...
const MENU_OPTIONS = [
  ...
  { id: 'reports', name: 'Rapports atelier', description: 'Statistiques et export des réparations' },
  ...
  { id: 'products', name: 'Produits (vente)', description: 'Produits vendables en caisse' },
