...
const MENU_OPTIONS = [
  ...
  { id: 'pos', name: 'Vente (Caisse)', description: 'Caisse, vente directe et paniers' },
  { id: 'repairs', name: 'Réparations (atelier)', description: 'Ordres de réparation et suivi' },
  { id: 'sales', name: 'Historique des Ventes', description: 'Suivi et recherche des ventes' },
  { id: 'products', name: 'Articles / Services (vente)', description: 'Articles et services vendables en caisse' },
  { id: 'parts', name: 'Pièces détachées (atelier)', description: 'Stock des pièces pour les réparations' },
  { id: 'clients', name: 'Gestion des Clients', description: 'Liste des clients et suivi des dettes' },
  { id: 'reports', name: 'Rapport & Statistique', description: 'Statistiques et export des réparations' },
  { id: 'expenses', name: 'Dépenses', description: 'Sorties de caisse : achats de pièces, charges, dépenses journalières' },
