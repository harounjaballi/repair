...
// Dépense : sortie d'argent de la caisse (achat de pièces, charges, dépense
// journalière…). Saisie manuellement dans le menu Dépenses. Les ajouts de
// stock (supplies) ne sont PAS des dépenses.
export type ExpenseCategory = 'achat_pieces' | 'charges' | 'journaliere' | 'autre';

export const EXPENSE_CATEGORY_LABELS: Record<ExpenseCategory, string> = {
  achat_pieces: 'Achat de pièces',
  charges: 'Charges (loyer, électricité…)',
...
export interface Expense {
  ...
  amount: number;             // montant retiré de la caisse
  by?: string;                // utilisateur ayant saisi
  ownerId?: string;
  createdAt?: string;
}
